            ...
            ?>
              <tr>
                <td><?php echo $atendimentonome?></td>                                   
                 <td class = "d-flex justify-content-end">
                  <a class="btn btn-warning btn-sm mr-3"  style="color:#fff" href="editarCadastro.php?id=<?php echo $array['atendimentotipo_id'] ?>" role="button"><i class="fa fa-pencil-square-o"></i> Editar</a> 
        ...
        <table class="table border table-striped">
          ...
          <tbody id = "tbodyCadastro">
            ...
            <tr>
              ...
              <td><?php echo $cro?></td>                
               <td class = "d-flex justify-content-end">
                  <a class="btn btn-warning btn-sm mr-3"  style="color:#fff" href="editarCadastro.php?id=<?php echo $array['id'] ?>" role="button"><i class="fa fa-pencil-square-o"></i> Editar</a> 
